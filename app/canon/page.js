    ...
    <div className="bg-white min-h-screen">
      ...
      <main className="container mx-auto py-6">
        ...
        <section className="bg-white border rounded-md shadow-sm p-6">
          ...
          {isExpanded && (
            <div className="mt-4">
              <p>
                The product name is usually located on the front or top of your
                printer. Please check your product for its exact model name.
              </p>
            </div>
          )}
        </section>
      ...
      <footer className="bg-gray-200 py-4">
        <div className="container mx-auto text-center text-gray-600 text-sm">
          &copy; 2023 Canon. All Rights Reserved.
        </div>
      </footer>
    </div>
  );
